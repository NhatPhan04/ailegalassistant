    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            ...
            sender: 'bot',
            content: `**Xin chào!** Tôi là trợ lý pháp lý AI Legal Assistant 
            
Tôi có thể giúp bạn tra cứu luật và phân tích hợp đồng. Hãy thử tải lên một file hợp đồng hoặc hỏi tôi:
...
* \`Quy định về thuế GTGT mới nhất?\``
    ...
    const handleSendMessage = async (query: string) => {
        ...
        const thinkingMsg: Message = { 
            id: botMsgId, 
            sender: 'bot', 
            content: `<i class="fas fa-spinner fa-spin"></i> Đang xử lý câu hỏi...`,
            isLoading: true
        };
